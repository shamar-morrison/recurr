...
>(function ActionsheetIcon({ className, size, ...props }, ref) {
  // If explicit height or width props are provided, use them without size styling
  ...
  // If size is a number, pass it directly
  ...
  // Default to 'sm' if no size is provided
  return (
    <UIActionsheet.Icon
